package com.peditx.hermex.profiles
...
class ProfilesViewModelTest {
    ...
    fun `filteredProfiles filters by display name, case-insensitively`() {
        val state = ProfilesUiState(
            profiles = listOf(
                com.peditx.hermex.core.network.dto.ProfileSummary(name = "Default"),
                com.peditx.hermex.core.network.dto.ProfileSummary(name = "Work"),
            ),
            searchQuery = "wo",
        )
