...
import com.peditx.hermex.core.network.dto.WorkspaceEntry
import com.peditx.hermex.core.network.dto.GitFileStatus
...
enum class FileUnavailableReason {
     ...
     * `binary: true` flag on an otherwise-fetched [com.peditx.hermex.core.network.dto.FileResponse]. */
    UNSUPPORTED_TYPE,
