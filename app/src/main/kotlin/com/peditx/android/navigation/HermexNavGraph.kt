package com.peditx.hermex.navigation
...
import com.peditx.hermex.AppContainer
import com.peditx.hermex.auth.AuthState
import com.peditx.hermex.chat.ChatScreen
import com.peditx.hermex.chat.ChatViewModel
import com.peditx.hermex.insights.InsightsScreen
import com.peditx.hermex.insights.InsightsViewModel
import com.peditx.hermex.memory.MemoryScreen
import com.peditx.hermex.memory.MemoryViewModel
import com.peditx.hermex.models.DefaultModelScreen
import com.peditx.hermex.models.DefaultModelViewModel
import com.peditx.hermex.onboarding.OnboardingScreen
import com.peditx.hermex.onboarding.OnboardingViewModel
import com.peditx.hermex.profiles.ProfilesScreen
import com.peditx.hermex.profiles.ProfilesViewModel
import com.peditx.hermex.projects.ProjectsScreen
import com.peditx.hermex.projects.ProjectsViewModel
import com.peditx.hermex.sessions.HermexDrawerContent
import com.peditx.hermex.sessions.SessionListNavItem
import com.peditx.hermex.sessions.SessionListScreen
import com.peditx.hermex.sessions.SessionListViewModel
import com.peditx.hermex.sessions.ShareDestinationPicker
import com.peditx.hermex.navigation.decodeUriList
import com.peditx.hermex.navigation.encodeUriList
import com.peditx.hermex.settings.CustomHeadersScreen
import com.peditx.hermex.settings.CustomHeadersViewModel
import com.peditx.hermex.settings.ServersScreen
import com.peditx.hermex.settings.ServersViewModel
import com.peditx.hermex.settings.SettingsScreen
import com.peditx.hermex.settings.SettingsViewModel
import com.peditx.hermex.skills.SkillDetailScreen
import com.peditx.hermex.skills.SkillDetailViewModel
import com.peditx.hermex.skills.SkillsScreen
import com.peditx.hermex.skills.SkillsViewModel
import com.peditx.hermex.tasks.TaskDetailScreen
import com.peditx.hermex.tasks.TaskDetailViewModel
import com.peditx.hermex.tasks.TasksScreen
import com.peditx.hermex.tasks.TasksViewModel
import com.peditx.hermex.ui.theme.ThemePickerScreen
import com.peditx.hermex.ui.theme.AppTheme
import com.peditx.hermex.workspace.GitActionsMenu
import com.peditx.hermex.workspace.GitCommitScreen
import com.peditx.hermex.workspace.KanbanBoardScreen
import com.peditx.hermex.workspace.WorkspaceScreen
import com.peditx.hermex.workspace.WorkspaceViewModel
import com.peditx.hermex.settings.ArchivedSessionsScreen
import com.peditx.hermex.settings.DefaultModelPickerScreen
import com.peditx.hermex.settings.DefaultProfilePickerScreen
import com.peditx.hermex.settings.IdentityEditorScreen
import com.peditx.hermex.settings.ProvidersScreen
import com.peditx.hermex.core.network.dto.KanbanCard
import com.peditx.hermex.core.network.dto.ModelCatalogGroup
import com.peditx.hermex.core.network.dto.SessionSummary
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = {
            if (isLoggedIn) {
                ...
                val store = remember { com.peditx.hermex.core.storage.DataStoreAppearancePreferencesStore(appContainer.context) }
