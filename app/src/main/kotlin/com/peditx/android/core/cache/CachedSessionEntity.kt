package com.peditx.hermex.core.cache
 ...
 * other secret -- those already have their own scoped stores (see [com.peditx.hermex.core.storage.CookieStore],
 * [com.peditx.hermex.core.storage.CustomHeadersStore]).
 */
 ...
 * (see [CachedMessageEntity]) -- lets [ChatViewModel][com.peditx.hermex.chat.ChatViewModel] treat
