...
import com.peditx.hermex.MainActivity
...
object HermexNotifier {
     ...
     * [com.peditx.hermex.core.storage.ChatPreferencesStore.loadNotificationsEnabled] -- this
     ...
     * this check the way only [com.peditx.hermex.core.notifications.HermexResponseCompletionNotifier]
     * used to. */
