 ...
 * [com.peditx.hermex.auth.AuthRepository] before any server has ever been resolved. Cookies live
 * only in process memory for this instance's lifetime; never shared across servers since each
 * gets its own instance (see [com.peditx.hermex.auth.AuthRepository]'s per-server-id cache). */
