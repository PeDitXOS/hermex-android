...
class NetworkModule(
     ...
     * [com.peditx.hermex.AppContainer] wires a real, persisted store. Placed before
    ...
    /** Applies every saved, [com.peditx.hermex.core.storage.CustomHttpHeader.isApplicable]
     ...
     * the listener callbacks. [com.peditx.hermex.core.util.TtftTracer] has its own separate
