...
fun SessionDisplaySettingsSection(
    ...
    onToggleMessageCount: () -> Unit,
    onToggleWorkspace: () -> Unit,
    onToggleCronSessions: () -> Unit,
    onToggleCliSessions: () -> Unit,
    onToggleClaudeCodeSessions: () -> Unit,
    onToggleSubagentSessions: () -> Unit,
...
fun ChatDisplaySettingsSection(
    ...
    onToggleThinkingExpanded: () -> Unit,
    onToggleToolExpanded: () -> Unit,
    onToggleStreamAnimation: () -> Unit,
    onToggleTimestamps: () -> Unit,
    onToggleWrapCode: () -> Unit,
    onToggleRtl: () -> Unit,
    onToggleHidePaths: () -> Unit,
    modifier: Modifier = Modifier,
) {
    Column(modifier = modifier) {
